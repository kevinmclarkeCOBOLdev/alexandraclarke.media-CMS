...
4. Browser Verification Policy: You do not need to perform browser testing after each code change / task. The test will be performed manually. Do NOT open the browser or launch browser subagents to conduct tests under any circumstances.
