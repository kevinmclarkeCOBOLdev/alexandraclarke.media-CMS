...
4. Browser Verification Policy: Do NOT open the browser or launch browser subagents to conduct tests under any circumstances. The user will perform all browser tests and verification manually.
